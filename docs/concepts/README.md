...
**Status:** Consolidated reference concept; architecture not yet frozen

- [Reference vehicle: Adaptive Expedition Trike](reference-vehicle.md) — consolidated end-to-end concept
- [Transforming chassis](transforming-chassis.md)
- [Tadpole layout](tadpole-layout.md)
