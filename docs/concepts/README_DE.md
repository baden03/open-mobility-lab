...
**Status:** Zusammengeführtes Referenzkonzept; Architektur noch nicht eingefroren

- [Referenzfahrzeug: Adaptive Expedition Trike](reference-vehicle_DE.md) — zusammengeführtes Gesamtkonzept
- [Transformierbares Fahrgestell](transforming-chassis_DE.md)
- [Tadpole-Anordnung](tadpole-layout_DE.md)
